...
$siteAyarCek = $db -> query("SELECT * FROM site_ayarlari");

foreach($siteAyarCek as $getSiteData) {
...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title><?php echo $getSiteData['Ayar_SiteBaslik']; ?></title>
						...
						<div class="swiper-slide dark" style="background-image: url('images/slider/swiper/1.jpg');">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp"><?php echo $getSiteData['Ayar_SiteBaslik']; ?>'ne Hoşgeldiniz!</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200"><?php echo $getSiteData['Ayar_SiteAciklama']; ?></p>
								</div>
							</div>
						</div>
